...
function buildManualChannelCreationPayload(data) {
  ...
  const row1 = new ActionRowBuilder().addComponents(
    new ButtonBuilder().setCustomId('tourney_wizard_manual_channels_set_format').setLabel('Channel Format').setStyle(ButtonStyle.Primary),
  ...
  const row2 = new ActionRowBuilder().addComponents(
    new ButtonBuilder().setCustomId('tourney_wizard_manual_channels_create').setLabel('Create Channels').setEmoji('✅').setStyle(ButtonStyle.Success).setDisabled(!ready),
