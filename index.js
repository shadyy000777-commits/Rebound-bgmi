...
const {
  ...
  handleTotalSlotsModalSubmit, handleReactionsModalSubmit,
  handleCreateRegChannelSelect, handleCreateConfirmChannelSelect, handleCreateRoleSelect,
  handleCreateRound2RoleSelect, handleRound2GroupSizeModalSubmit,
...
client.on('interactionCreate', async (interaction) => {
  ...
  try {
    if (interaction.isChatInputCommand()) {
      ...
      } else if (interaction.customId === 'tourney_create_regchannel_select') {
        await handleCreateRegChannelSelect(interaction);
      ...
      if (interaction.customId === 'tourney_create_role_select') {
        await handleCreateRoleSelect(interaction);
      } else if (interaction.customId === 'tourney_create_round2role_select') {
        await handleCreateRound2RoleSelect(interaction);
      }
      ...
      else if (interaction.customId === 'tourney_create_settings_g_modal') await handleReactionsModalSubmit(interaction);
      else if (interaction.customId === 'tourney_create_settings_i_modal') await handleRound2GroupSizeModalSubmit(interaction);
