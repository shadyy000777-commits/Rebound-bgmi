// Holds in-progress "Verify" data between the 3 modal steps.
...
//
// This is intentionally in-memory only — if the bot restarts mid-verification
// the user just clicks "Verify" again and starts over. Nothing is saved to
...
function startPending(userId, guildId, mode = 'create', original = null) {
  ...
  const entry = {
    guildId,
    mode,        // 'create' (fresh /verify) or 'edit' (updating an existing record)
